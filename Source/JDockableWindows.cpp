...
{
	DockableComponentWrapper* d = new DockableComponentWrapper(*this, component);
...
{
	g.fillAll(frontTab ? Colours::white : Colours::darkgrey);
...
void WindowDockVertical::addComponentToDock(Component* comp, int row , int col )
{
	DockableComponentWrapper * dockable = manager.createDockableComponent(comp);
...
void TabDock::addComponentToDock(Component* comp, int row , int col )
{
